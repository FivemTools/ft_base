...
RegisterNetEvent('ft_base:OpenMenu')
AddEventHandler('ft_base:OpenMenu', OpenMenu)

RegisterNetEvent('ft_base:Next')
AddEventHandler('ft_base:Next', NextMenu)

RegisterNetEvent('ft_base:AddMenu')
AddEventHandler('ft_base:AddMenu', AddMenu)

RegisterNetEvent('ft_base:RemoveMenu')
AddEventHandler('ft_base:RemoveMenu', RemoveMenu)

RegisterNetEvent('ft_base:AddMenuButton')
AddEventHandler('ft_base:AddMenuButton', AddMenuButton)

RegisterNetEvent('ft_base:RemoveMenuButton')
AddEventHandler('ft_base:RemoveMenuButton', RemoveMenuButton)

RegisterNetEvent('ft_base:CleanMenuButtons')
AddEventHandler('ft_base:CleanMenuButtons', CleanMenuButtons)

RegisterNetEvent('ft_base:SetMenuButtons')
AddEventHandler('ft_base:SetMenuButtons', SetMenuButtons)

RegisterNetEvent('ft_base:SetMenuValue')
AddEventHandler('ft_base:SetMenuValue', SetMenuValue)

RegisterNetEvent('ft_base:CloseMenu')
AddEventHandler('ft_base:CloseMenu', CloseMenu)

RegisterNetEvent('ft_base:BackMenu')
AddEventHandler('ft_base:BackMenu', BackMenu)

RegisterNetEvent('ft_base:FreezeMenu')
AddEventHandler('ft_base:FreezeMenu', FreezeMenu)
